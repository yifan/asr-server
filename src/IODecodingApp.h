...
#ifndef APIAI_DECODER_IODecodingApp_H_
#define APIAI_DECODER_IODecodingApp_H_
...
public:
	...
	IODecodingApp(Decoder &decoder) : decoder_(decoder),
...
#endif /* APIAI_DECODER_IODecodingApp_H_ */
